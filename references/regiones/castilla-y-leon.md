...
- **Discapacidad:** Se duplican las cantidades si el hijo tiene discapacidad >= 33%
- **Requisitos:** Hijo nacido o adoptado en el periodo impositivo 2025
- **Aplicacion:** En declaracion individual de cada progenitor
- **Transicion:** Importe generado en ejercicios anteriores se aplica obligatoriamente en 2025
...
- **Aplicacion:** Puede acumularse con otras deducciones
...
- **Base:** Aportaciones documentadas
...
- **Base:** Escritura de compraventa, contrato construccion, presupuesto reformas
...
- **Requisitos:**
  ...
  - En municipio rural cuando aplique
- **Documentacion:** Certificado de subvencion y gastos totales
...
- **Requisitos:**
  ...
  - Rehabilitacion de vivienda existente
- **Aplicacion:** Generadora de futuras deducciones por alquiler de vivienda rural
...
### 13. Por cantidades invertidas en la recuperacion del patrimonio historico, cultural y natural
...
- **Porcentaje:** 15% de cantidades donadas
- **Beneficiarios:**
  - Rehabilitacion/conservacion bienes en Castilla y Leon del Patrimonio Historico/Cultural inscritos en Registro o Inventario general
...
- **Tipos de vehiculos elegibles:**
  ...
  - Vehiculo hibrido enchufable con autonomia en modo electrico > 40 km
- **Requisitos:**
