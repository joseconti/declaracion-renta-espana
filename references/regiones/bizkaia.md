...
4. Deducciones familiares y personales
...
## 1. ESCALA GENERAL DEL IMPUESTO (Base Liquidable General)

La base liquidable general se grava aplicando tipos progresivos:

| Tramo (euros) | Cuota integra acumulada (euros) | Tipo aplicable (%) |
|---|---|---|
| Hasta 17.720,00 | 0,00 | 23,00 |
| 17.720,01 a 35.440,00 | 4.075,60 | 28,00 |
| 35.440,01 a 53.160,00 | 9.037,20 | 35,00 |
| 53.160,01 a 75.910,00 | 15.239,20 | 40,00 |
| 75.910,01 a 105.130,00 | 24.339,20 | 45,00 |
| 105.130,01 a 140.130,00 | 37.488,20 | 46,00 |
| 140.130,01 a 204.270,00 | 53.588,20 | 47,00 |
| 204.270,01 en adelante | 83.734,00 | 49,00 |

**Calculo de la cuota integra general:**
- Se multiplica la base liquidable general por el tipo medio de gravamen
...
La base liquidable del ahorro se grava a tipos proporcionales:

| Tramo de base liquidable del ahorro (euros) | Tipo aplicable (%) |
|---|---|
| Hasta 2.500,00 | 20 |
| 2.500,01 a 10.000,00 | 21 |
| 10.000,01 a 15.000,00 | 22 |
| 15.000,01 a 30.000,00 | 23 |
| 30.000,01 en adelante | 25 |

**Calculo en forma de escala acumulada:**

| Base liquidable del ahorro hasta (euros) | Cuota integra (euros) | Resto hasta (euros) | Tipo (%) |
|---|---|---|---|
| 0 | 0 | 2.500 | 20 |
| 2.500 | 500 | 10.000 | 21 |
...
**Tipo medio de gravamen del ahorro:** (Cuota resultante / Base liquidable ahorro) x 100
...
Las bonificaciones anteriores se incrementan en:
- **100%** para trabajadores activos discapacitados con grado de discapacidad 33%-64%
- **250%** para trabajadores activos discapacitados con grado de discapacidad ≥33% y estado carencial de movilidad reducida (BLAM ≥ 25%), o grado de discapacidad ≥65%

---

## 4. DEDUCCIONES FAMILIARES Y PERSONALES

### 4.1. Deduccion por Descendientes

**Cuantias (anuales):**
- 1er descendiente: 668 euros
- 2do descendiente: 827 euros
- 3er descendiente: 1.393 euros
- 4to descendiente: 1.647 euros
- 5to y sucesivos: 2.151 euros cada uno

**Deduccion complementaria:** 386 euros anuales por cada descendiente menor de 6 anos (sumado al anterior)

**Requisitos:**
- Edad del descendiente: no superior a 30 anos (excepto si tiene dependencia o discapacidad)
- Rentas del descendiente: no superiores a 15.876 euros anuales (SMI 2024)
- El descendiente no forma parte de otra unidad familiar con rentas > 15.876 euros
- El descendiente no presenta (o no tiene obligacion de presentar) declaracion de IRPF

**Prorrateo:** Cuando varios ascendientes conviven con los mismos descendientes, se divide entre partes iguales

### 4.2. Deduccion por Ascendientes

**Cuantia:** 321 euros anuales por cada ascendiente que conviva de forma continua

**Requisitos:**
- Rentas del ascendiente: no superiores a 15.876 euros anuales (SMI 2024)
- El ascendiente no forma parte de otra unidad familiar con rentas > 15.876 euros
- El ascendiente no presenta (o no tiene obligacion de presentar) declaracion de IRPF

### 4.3. Deduccion por Edad

**Para contribuyentes con base imponible ≤ 20.000 euros:**

| Edad | Deduccion (euros) |
|---|---|
| Mayor de 65 anos | 385 |
| Mayor de 75 anos | 700 |

**Para base imponible > 20.000 y < 30.000 euros:**
- Mayor de 65 anos: 385 - [0,0385 x (Base imponible - 20.000)]
- Mayor de 75 anos: 700 - [0,0700 x (Base imponible - 20.000)]

**Nota:** En tributacion conjunta, la deduccion se aplica siempre que base imponible conjunta ≤ 35.000 euros

### 4.4. Deduccion por Abono de Anualidades por Alimentos (Hijos)

- Deduccion: 15% de las cantidades abonadas por decision judicial
- Limite por hijo: 30% de la deduccion por descendiente correspondiente

**Limites 2024:**
- 1er hijo: 200,4 euros
- 2do hijo: 248,1 euros
- 3er hijo: 417,9 euros
- 4to hijo: 494,1 euros
- 5to y sucesivos: 645,3 euros

**Nota especial:** Si hay guarda y custodia compartida, solo aplica al progenitor que pague mayor cantidad
...
### 5.1. Deduccion por Alquiler de Vivienda Habitual

**Opcion general:**
- 20% de cantidades pagadas, con limite de 1.600 euros anuales

**Familia numerosa:**
- 25% de cantidades pagadas, con limite de 2.000 euros anuales

**Menores de 30 anos:**
- 30% de cantidades pagadas, con limite de 2.400 euros anuales

**Nota:** De las cantidades pagadas se restaran subvenciones percibidas que sean exentas
...
Aunque cumplan los limites anteriores, TIENEN OBLIGACION DE DECLARAR si:
- Perciben rendimientos de trabajo de mas de un pagador (excepto si suma de 2do y posteriores no supera 2.000 euros)
- Han suscrito mas de un contrato de trabajo en el ejercicio
- Perciben pensiones compensatorias o anualidades por alimentos
- Tienen retenciones calculadas con normativa diferente o no ingresadas en Diputacion Foral
- Perciben peonadas o jornales diarios
- Trabajadores de pesca con retribuciones en participacion de capturas
- Perciben retribuciones variables que superen lo tenido en cuenta para retenciones
- Incumplen condiciones para disfrutar de exenciones, bonificaciones, reducciones o deducciones

---

## 8. REDUCCIONES Y TRATAMIENTO DE RENDIMIENTOS

### 8.1. Reduccion de Rendimientos del Trabajo (Integracion)

**Rendimientos con periodo de generacion > 2 anos:**

| Periodo de generacion | Porcentaje de integracion | Concepto |
|---|---|---|
| Hasta 2 anos | 100% | Rendimiento integro = importe total |
| > 2 anos y ≤ 5 anos | 60% | Premios antiguedad, etc. |
| > 5 anos | 50% | Indemnizaciones, premios larga antigüedad |
| Calificados irregulares | 50% | Segun reglamento |

**Limite anual:** 300.000 euros de aplicacion de porcentajes reducidos (el exceso se integra al 100%)

**Excepcion:** Rendimientos percibidos antes de 1.1.2014 no se aplica el limite de 300.000 euros

**Ejemplo:** Premio de permanencia de 25 anos percibido en 2024 por 40.000 euros:
- Periodo de generacion: 25 anos (> 5 anos)
- Porcentaje de integracion: 50%
- Rendimiento integro = 40.000 x 0,5 = 20.000 euros

### 8.2. Gastos Deducibles de Rendimientos del Trabajo

**Gastos deducibles admitidos:**
- Cotizaciones a la Seguridad Social (obligatorias)
- Cotizaciones a Mutualidades Generales obligatorias del funcionariado
- Detracciones por derechos pasivos
- Cotizaciones a Colegios de Huerfanos o instituciones similares
- Gastos de desplazamiento (limite: 20% de rendimientos integrales si se opta por regimen especial para desplazados, con justificacion documental)
- Aportaciones obligatorias a organizaciones politicas (limite: 25% de rendimientos integrales)

**Gastos NO deducibles admitidos sin ingresos por tal concepto:**
- Cotizaciones por Convenio Especial con Seguridad Social
- Cuotas a Colegios de Huerfanos y Mutualidades obligatorias
...
- Tengo rentas del trabajo por 18.000 euros. Tengo obligacion de declarar?
  - Respuesta: Depende. Si es un unico pagador, probablemente no (salvo excepciones). Si son varios pagadores y la suma de 2do y posteriores > 2.000 euros, SI tiene obligacion.

- Tengo rendimientos de capital de 1.200 euros. Debo declarar?
  - Respuesta: No, si esta por debajo de 1.600 euros (limite).

### Sobre deducciones:
- Cuanto puedo deducir por alquiler de vivienda?
  - Respuesta: Depende de tu edad y situacion familiar. General: 20% del alquiler (max. 1.600 euros). Si menores de 30 anos: 30% (max. 2.400 euros). Si familia numerosa: 25% (max. 2.000 euros).

- Tengo un hijo menor de 30 anos. Que deduccion aplica?
  - Respuesta: Deduccion por descendiente: 668 euros (primero). Mas 386 euros si tiene menos de 6 anos.

- Puedo deducir aportaciones a un plan de pensiones?
  - Respuesta: Si, dentro de limites. Consulta los limites especificos por tipo de sistema de prevision social en el manual.

### Sobre el calculo de la cuota:
- Como se calcula mi impuesto si tengo base liquidable de 40.000 euros?
  - Respuesta: Aplicar escala general. Corresponde a: 9.037,20 + [(40.000 - 35.440) x 0,40] = 9.037,20 + 1.824 = 10.861,20 euros (antes de deducciones)
...
- Redaccion finalizada: 1 de marzo de 2025

**Ubicacion oficial:**
- Sede electronica de la Diputacion Foral de Bizkaia (www.bizkaia.eus)
- Borradores de declaracion (proporcionados por Departamento de Hacienda)

**Normativa aplicable:**
- Norma Foral del Impuesto sobre la Renta de las Personas Fisicas (THB)
- Decreto Foral 214/2023, de 28 de diciembre (retenciones y pagos a cuenta)
- Instruccion 1/2024, de 8 de abril, de la Direccion General de Hacienda

**Avisos importantes:**
1. Este documento se basa en el manual 2024. Para ejercicios posteriores, verificar en fuentes oficiales los importes actualizados.
2. Los porcentajes, limites y cuantias estan sujetos a cambios anuales.
...
**Ultima actualizacion:** Basado en documentacion oficial de marzo de 2025
**Ejercicio fiscal:** 2024
**Jurisdiccion:** Territorio Historico de Bizkaia (Pais Vasco)
