...
- **Tipos de inversiones:**
  ...
  - Minimo mejora en un nivel la calificacion de eficiencia energetica
...
- **Requisitos:**
  ...
  - Registro de certificados de eficiencia energetica antes y despues de las inversiones
  - Acreditacion mediante facturas que cumplan requisitos legales
  - Si es arrendador: contrato de arrendamiento >= 1 ano, deposito de fianza constituido, contribuyente declara rendimientos del capital inmobiliario, no repercute costes a arrendatario

### 2. Por arrendamiento de la vivienda habitual en el territorio de las Illes Balears

#### A. Jovenes (< 36 anos) y mayores (>= 65 anos sin actividad laboral)
- **Porcentaje:** 15% de importes satisfechos
- **Limite maximo:** 530 euros

#### B. Menores de 30 anos, discapacidad >= 33%, derecho minimo por discapacidad, familias numerosas/monoparentales, autonomos
- **Porcentaje:** 20% de importes satisfechos
- **Limite maximo:** 650 euros

#### Requisitos comunes
- **Base imponible:**
  - General: 33.000 euros (individual) / 52.800 euros (conjunta)
  - Familias numerosas categoria general o monoparentales con 2+ hijos: 39.600 euros (individual) / 63.360 euros (conjunta)
...
- **Limite maximo:**
  ...
  - 350 euros por hijo (menores de 30 anos, discapacidad >= 33%, derecho minimo por discapacidad, familias numerosas/monoparentales, autonomos)
- **Requisitos:**
  ...
  - Solo hijos que den derecho al minimo por descendientes
...
- **Limite maximo:** 110 euros por hijo (aplicable globalmente para el conjunto de hijos)
- **Enseñanza deducible:**
...
- **Enseñanza no deducible:**
  ...
  - Campamentos de verano en el extranjero o territorio nacional
...
- **Limite maximo:** 50% de la cuota integra autonomica (casilla 0546)
...
- **Requisitos:**
  ...
  - Estudios abarquen un curso academico completo o un minimo de 30 creditos
  - Base imponible no supera 33.000 euros (individual) / 52.800 euros (conjunta)
...
- **Requisitos:**
  - Contrato de arrendamiento de vivienda >= 1 ano con mismo arrendatario
...
- **Limite maximo:** 440 euros anuales (aplicable de forma global)
- **Requisitos:**
  - Contrato de arrendamiento >= 1 ano
...
- **Limite maximo:** 600 euros anuales
- **Requisitos:**
  ...
  - Traslado temporal no rebase los tres anos de duracion
...
- **Limite maximo:** 150 euros por contribuyente
...
- **Limite maximo:** 300 euros por contribuyente anuales
- **Beneficiarios:**
...
- **Limite maximo:** 200 euros anuales
- **Beneficiarios:**
...
- **Limite maximo:** 165 euros anuales
- **Beneficiarios:**
...
- **Limite maximo:** 660 euros anuales (general) o 900 euros (familias numerosas, menores de 30, con discapacidad >= 33%, autonomos)
...
- **Requisitos:**
  - Solo descendientes o acogidos que den derecho al minimo por descendientes
...
- **Requisitos:**
  - Personas mayores de 65 anos o con discapacidad >= 33%
  - Ascendientes o descendientes que no dan derecho a minimos (aunque puedan aplicarse mínimos)
...
- **Requisitos:**
  ...
  - Que generen derecho al minimo por descendientes/ascendientes
  - Base imponible no supera 52.800 euros (individual) / 84.480 euros (conjunta)
...
- **Limite maximo:** 6.000 euros anuales (para inversiones 2023-2025)
- **Requisitos:**
  - Entidades constituidas entre 2 y 10 anos antes de la inversion
  - Domicilio social y fiscal en Illes Balears
  - Participacion no superior al 25% del capital social
  - Inversion mantenida un minimo de 5 anos
...
- **Requisitos:**
  ...
  - Actividad debe mantener durante al menos 3 anos
  - Base imponible no supera 33.000 euros (individual) / 52.800 euros (conjunta)
...
1. Pagas alquiler de vivienda habitual en Baleares? Tienes menos de 36 anos o mas de 65 anos sin actividad?
...
7. Tienes hijos menores de 6 anos en guarderia o servicios de cuidado?
8. Tienes ascendientes o descendientes mayores de 65 anos o con discapacidad?
