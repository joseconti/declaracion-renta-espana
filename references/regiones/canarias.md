...
- **Beneficiarios:**
  - Entidades públicas dependientes de Canarias, cabildos insulares, corporaciones municipales
  - Cuya finalidad sea defensa y conservacion del medio ambiente
  - Entidades sin fines lucrativos inscritas en registros
- **Requisitos:** Acreditacion mediante certificacion de entidad donataria con NIF, datos identificativos, fecha, destino e importe
...
- **Beneficiarios:**
  ...
  - Iglesia católica
  - Fundaciones y asociaciones (Ley 49/2002)
- **Requisitos:**
  - Bienes inscritos en Registro Canario de Bienes de Interes Cultural
  - O incluidos en Inventario de Bienes Muebles
  - Certificacion con mencion expresa de donacion irrevocable y aceptada
...
- **Destinos y bases maximas:**
  ...
  - Empresas cientificas (investigacion): base maxima 3.000 euros
  - Universidades, centros de investigacion, ensenanzas artisticas: base maxima 50.000 euros
- **Incompatibilidades:** No compatible con otras deducciones por mismo beneficiario y cantidad
...
- **Porcentaje escala:**
  - 20% hasta 150 euros
  - 15% resto de base
  - 17,5% si reiteracion en 2 periodos anteriores
- **Base maxima:** 10% de base liquidable del contribuyente
- **Beneficiarios:** Entidades sin fines lucrativos conforme a Ley 49/2002
- **Incompatibilidades:** No compatible con deducciones por donaciones ecologicas o culturales para mismos beneficiarios
...
- **Porcentaje:** 10% de cantidades destinadas
- **Limites maximo:**
  - 10% de cuota integra autonomica (casilla 0546), Y
...
- **Estudios elegibles:**
  ...
  - Artes plasticas/diseño grado superior
...
- **Requisitos:**
  - Descendientes en edad de escolarizacion obligatoria
  - Gastos de matricula, libros, material escolar
...
- **Requisitos:**
  ...
  - Documentacion acreditativa de discapacidad o edad
...
- **Requisitos:**
  ...
  - Menor sin amparo familiar
  - Documentacion de los servicios sociales acreditando acogimiento
  - Permanencia del menor durante el periodo impositivo
...
- **Requisitos:**
  ...
  - Mejora de al menos una categoria en clasificacion energetica
...
- **Requisitos:**
  ...
  - Obras estrictamente necesarias para accesibilidad
  - Acreditacion mediante proyecto tecnico
...
- **Requisitos:**
  ...
  - Arrendamiento de la vivienda adquirida por dacion
...
- **Requisitos:**
  - Inmueble destinado a arrendamiento como vivienda habitual
  - Ubicado en Canarias
...
- **Requisitos:**
  ...
  - Inscripcion en SEPE
  - Percepcion de prestacion por desempleo
  - Minimo 183 dias en situacion de desempleo
...
- **Gastos deducibles:**
  ...
  - Aparatos medicos necesarios
  - Prótesis y ortopedias
- **Requisitos:**
  - Gastos no cubiertos por Seguridad Social o seguros
  - Acreditacion mediante recetas y facturas
  - Enfermedad acreditada medicamente
...
- **Requisitos:**
  ...
  - Residencia común o acreditada dependencia economica
  - Documentacion de discapacidad
...
- **Requisitos:**
  ...
  - Empleado para cuidado de menores, mayores o dependientes
  - Alta registrada en SS

### 28. Límites comunes y obligaciones formales para aplicar las deducciones

- **Limites comunes:**
  - Base imponible general entre 12.000 y 36.000 euros
  - Base liquidable entre 0 y 40.000 euros
  - Suma de deducciones no puede superar cuota integra autonomica
- **Obligaciones:**
  - Conservar documentacion acreditativa
  - Presentar en anexos correspondientes de declaracion
  - Acreditacion mediante facturas, certificados, resoluciones administrativas
...
1. Has residido en Canarias al menos 183 dias durante 2025?
...
15. Pagas cuotas a Seguridad Social por empleados del hogar?
